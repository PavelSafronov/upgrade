...
const rule: Rule.RuleModule = {
  meta: {
    ...
    fixable: 'code',
    messages: {
      removed: "'{{name}}' was removed from GridFS write stream options in mongodb v7. Remove this option.",
    },
    docs: {
      description: 'Disallow removed GridFS options (contentType, aliases) in v7',
