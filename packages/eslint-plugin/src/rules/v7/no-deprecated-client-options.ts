...
const rule: Rule.RuleModule = {
  meta: {
    ...
    fixable: 'code',
    messages: {
      removed: "'{{name}}' was removed in mongodb v7 (it was a no-op since v4). Remove this option.",
    },
    docs: {
      description: 'Disallow deprecated MongoClient options removed in v7 (useNewUrlParser, useUnifiedTopology, noResponse, retryWrites)',
